import { ENDPOINT, GET_REPO, TOKEN } from '../constants/query';
import { RepoData, SearchCriteria } from './type';
...
export async function getRepo(searchCriteria: SearchCriteria) {
  const response = await fetch(ENDPOINT!, {
    body: JSON.stringify({ query: GET_REPO, variables: { org: searchCriteria.org, repo: searchCriteria.repo } }),
